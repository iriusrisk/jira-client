...
public class JiraClient {
     ...
     *
     * @param key            Issue key (PROJECT-123)
     * @param includedFields Specifies which issue fields will be included in the result.
     ...
     *
     * @param jql JQL statement
     * @return a search result structure with results (issues include all navigable fields)
     * @throws JiraException when the search fails
     */
    ...
    /**
     * Search for issues with the given query and specify which fields to retrieve. If the total results is bigger than
     * the maximum returned results, then further calls can be made using different values for the <code>startAt</code>
     ...
     *                       <li>*all,-comment - include all fields</li>
     *                       </ul>
     * @param maxResults     if non-<code>null</code>, defines the maximum number of results that can be returned
     * @param startAt        if non-<code>null</code>, defines the first issue to return
     * @return a search result structure with results
     * @throws JiraException when the search fails
     */
    public Issue.SearchResult searchIssues(String jql, String includedFields,
     ...
     *
     * @return all projects; not all data is returned for each project; to get the extra data use {@link
     * #getProject(String)}
